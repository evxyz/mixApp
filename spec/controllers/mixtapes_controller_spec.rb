...
describe MixtapesController do
  ...
  # MixtapesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested mixtape as @mixtape" do
      mixtape = Mixtape.create! valid_attributes
      get :show, {:id => mixtape.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested mixtape as @mixtape" do
      mixtape = Mixtape.create! valid_attributes
      get :edit, {:id => mixtape.to_param}, valid_session
      assigns(:mixtape).should eq(mixtape)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Mixtape" do
        expect {
          post :create, {:mixtape => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mixtape as @mixtape" do
        ...
        post :create, {:mixtape => {}}, valid_session
        assigns(:mixtape).should be_a_new(Mixtape)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mixtape" do
        ...
        put :update, {:id => mixtape.to_param, :mixtape => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested mixtape as @mixtape" do
        mixtape = Mixtape.create! valid_attributes
        put :update, {:id => mixtape.to_param, :mixtape => valid_attributes}, valid_session
        assigns(:mixtape).should eq(mixtape)
      end
    ...
    describe "with invalid params" do
      it "assigns the mixtape as @mixtape" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mixtape.any_instance.stub(:save).and_return(false)
        put :update, {:id => mixtape.to_param, :mixtape => {}}, valid_session
        assigns(:mixtape).should eq(mixtape)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested mixtape" do
      mixtape = Mixtape.create! valid_attributes
      expect {
        delete :destroy, {:id => mixtape.to_param}, valid_session
      }.to change(Mixtape, :count).by(-1)
    end
